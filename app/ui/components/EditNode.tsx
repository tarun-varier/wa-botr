...
import { responses } from "@/app/lib/triggerList";
            ...
            <SheetContent >
                ...
                <div className="my-8 space-y-8">
                    <div >
                        ...
                        <Combobox item="trigger" items={responses} />
                        <div className="flex items-center justify-between my-4">
                            <span className="text-base font-bold">Rules</span>
                            <Button variant="ghost" className="flex items-center space-x-2 shadow-sm">
                    ...
                    <div >
                        ...
                        <Combobox item="response" items={responses} />
                        <div className="flex items-center justify-between my-4">
